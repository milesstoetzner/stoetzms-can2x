...
bridge
    ...
    .addOption(
        new Option('--receiver [string]', '').default('can').choices(['can', 'console', 'http', 'socket-io', 'ws'])
    )
    ...
    .addOption(
        new Option('--sender [string]', '').default('console').choices(['console', 'file', 'http', 'socket-io', 'ws'])
    )
